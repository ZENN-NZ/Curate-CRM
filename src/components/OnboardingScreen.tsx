...
import { Hexagon, Building2, Link2, Mail, KeyRound, ArrowRight, ShieldCheck, CheckCircle2, AlertCircle, Loader2, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-indigo-950 flex flex-col justify-center items-center p-4 sm:p-6 text-zinc-100 font-sans selection:bg-blue-600 selection:text-white">
      ...
      <div className="relative max-w-md w-full bg-zinc-900/90 border border-zinc-800 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <h1 className="text-2xl font-black tracking-tight text-white">Welcome to Curate</h1>
          <p className="text-xs sm:text-sm text-zinc-400 mt-1">
            Local-First, Multi-Tenant Contact & Relationship CRM
          </p>
        </div>

        {/* Mode Toggle Tabs */}
        <div className="grid grid-cols-2 gap-1 bg-zinc-800/80 p-1 rounded-xl mb-6 border border-zinc-700/40">
          <button
            type="button"
            onClick={() => { setMode('create'); setCreateStep('details'); setCreateError(''); }}
            className={`flex items-center justify-center py-2 rounded-lg text-xs sm:text-sm font-semibold transition-all ${
              mode === 'create'
